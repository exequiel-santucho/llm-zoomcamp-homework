...
**Respuesta:** -0.02 (valor real: -0.0206)
...
**Respuesta:** 0.37 (valor real: 0.3611)
...
**Respuesta:** `02-vector-search/lessons/07-sqlitesearch-vector.md` (score: 0.6489)
...
**Respuesta:** `04-evaluation/lessons/05-search-metrics.md`
...
**Respuesta:** `02-vector-search/lessons/08-pgvector.md`
...
**Respuesta:** `01-agentic-rag/lessons/13-function-calling.md`
