...
**Respuesta:** 72 páginas de lecciones
...
**Respuesta:** `01-agentic-rag/lessons/14-agentic-loop.md`
...
**Respuesta:** 7000 input tokens (actual: 5724 con Groq/Mixtral)
...
**Respuesta:** 3x fewer (5724 sin chunking -> 1451 con chunking = 3.9x reducción)
...
**Respuesta:** 4 llamadas a search (actual: 3 con Groq/Mixtral)
